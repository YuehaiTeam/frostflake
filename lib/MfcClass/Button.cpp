...
Button::Button(Control* parent, std::wstring name, RECT rect)
...
Button::Button(Control* parent, std::wstring name, int width, int height)
...
Button::Button(std::wstring name, int width, int height)
