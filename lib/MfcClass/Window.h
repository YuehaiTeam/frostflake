...
public:
	Window();
	Window(std::wstring, int = 320, int = 240);
	Window(Control*, std::wstring, int = 0, int = 0);
	...
	void setOnCustomMessage(f_onCustomMessage);
	...
	void setMenu(HMENU);
protected:
	Window(Control*, std::wstring, DWORD, int = 320, int = 240);
