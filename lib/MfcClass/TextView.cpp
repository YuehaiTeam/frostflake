...
TextView::TextView(Control* parent, std::wstring name, RECT rect)
...
TextView::TextView(Control* parent, std::wstring name, int width, int height)
...
void TextView::setText(std::wstring txt)
{
	Control::setText(txt);
	autosize();
}
